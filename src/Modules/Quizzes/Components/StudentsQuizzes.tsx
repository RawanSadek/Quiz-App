...
import JoinQuizPopUp from "./JoinQuizPopUp";

export default function StudentsQuizzes() {
  ...
  return (
    <>
      ...
      <div
        ...
        className="w-[190px] flex flex-col justify-center items-center border border-gray-300 rounded-lg p-5 cursor-pointer hover:shadow-lg hover:scale-110 transition-all duration-400"
      >
        <BiSolidAlarmAdd className="text-[55px] mx-auto" />
        <h3 className="text-lg font-semibold">Join quiz</h3>
      </div>

      <div className="flex justify-between items-start flex-grow gap-5 w-full mt-8">
        {/* Upcomming Quizzes */}
      ...
      <FormPopUp
        ...
        mode={formMode}
        content={
          <JoinQuizPopUp mode={formMode} onSave={handleSaveQuiz} ref={formRef} />
        }
      />
    </>
  );
